...
アプリアイコンと共通する透明な縁、曇りガラスの面、緑のアクセントを使った Liquid Glass 風の外観です。レイアウトや操作を主張させすぎず、作業中のウィンドウになじむ小さなツールとして設計しています。
...
棚内で項目をドラッグしても並べ替えや複製は行いません。棚ではファイル名を変更せず、元のファイル名をそのまま表示します。
...
- macOS 26 以降
- Xcode Command Line Tools 26 以降
- Swift 6.2 以降（Swift 5言語モード）
